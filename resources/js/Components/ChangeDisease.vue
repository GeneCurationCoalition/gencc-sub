<script setup>
    ...
    const [disease] = defineField('disease');
    ...
    async function checkEntry() {
        try {
            ...
            {
                cardTitle.value = response.data.message + '   (' + disease.value + ')'
                cardBody.value = "";
            }
    ...
    const emit = defineEmits(['input_dialog_close', 'input_disease_item', 'clear_api_error'])
    ...
    function closeCallback()
    {
        ...
        emit('input_disease_item', disease.value);
        ...
        <Dialog v-model:visible="visible" modal @show="initializeInput" header="header" class="ring-8 ring-sky-500" :style="{ width: '50rem' }">
            ...
            <div class="grid grid-cols-4">
                ...
                <div class="flex items-center col-span-3 gap-3">
                    <InputText type="text" v-model="disease" class="flex-auto" autocomplete="off" />
