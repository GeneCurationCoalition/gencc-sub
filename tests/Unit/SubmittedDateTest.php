...
class SubmittedDateTest extends TestCase
{
    public static function acceptedCases(): array
    {
        return [
            ...
            'basic negative offset from official template' => ['2020-01-28T16:22:37-0700', '2020-01-28'],
            'basic positive offset' => ['2024-01-15T13:45:59+0530', '2024-01-15'],
            'basic maximum offset' => ['2024-01-15T13:45:59+1400', '2024-01-15'],
    ...
    public static function rejectedCases(): array
    {
        return [
            ...
            'basic offset beyond ISO limit' => ['2024-01-15T12:30:00+1500', 'Not a date'],
            'offset beyond fourteen exactly' => ['2024-01-15T12:30:00-14:01', 'Not a date'],
            'basic offset beyond fourteen exactly' => ['2024-01-15T12:30:00-1401', 'Not a date'],
            'invalid offset minute' => ['2024-01-15T12:30:00+01:60', 'Not a date'],
            'invalid basic offset minute' => ['2024-01-15T12:30:00+0160', 'Not a date'],
